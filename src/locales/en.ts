export default {
  ...
  login: {
    ...
    forgetPasswordConfirm: 'Reset password',
    forgetPasswordConfirmSuccess: 'Password reset successfully',
    forgetPasswordConfirmFailed: 'Password reset failed',
  ...
  auth: {
    welcome: 'Welcome to FulinxEcommerce System',
    message: 'FulinxEcommerce',
    username: 'Username',
    email: 'Email',
    goToRegister: 'No account? Go to register',
    password: 'Password',
    ...
    captchaValuePlaceholder: 'Please enter captcha',
    goToLogin: 'Already have an account? Go to login',
    registerSuccess: 'Registration successful, please check your email and click the confirmation link to complete registration',
    registerConfirm: 'Registration Confirmation',
    registerConfirmDescription: 'Please click the button below to complete registration confirmation',
    confirmRegistration: 'Confirm Registration',
    registerConfirmSuccess: 'Registration confirmation successful',
    registerConfirmFailed: 'Registration confirmation failed',
