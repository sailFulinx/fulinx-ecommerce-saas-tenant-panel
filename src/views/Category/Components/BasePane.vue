...
const handleClickUpdateCategoryFile = async ({ fileData }: { fileData: FileData }) => {
  if (currentItem.categoryDetailListResultDo?.id) {
    let fileId
    ...
    const { data } = await categoryFileEditApi({
      categoryDetailId: currentItem.categoryDetailListResultDo.id,
...
<template>
  <div v-if="currentItem">
    <ElCard v-if="currentItem.categoryDetailListResultDo" shadow="never" class="mb-5">
      <div class="w-full mt-0 pt-0">
        ...
        <div class="w-full grid grid-cols-12 gap-8 p-4 border-b border-gray-200">
          ...
          <div class="col-span-11 w-full flex items-center">
            <span v-if="!inputCategoryNameVisible" class="mr-2">
              {{ currentItem.categoryDetailListResultDo.categoryName }}
            </span>
            <span v-else>
              <ElInput
                ...
                style="width: 300px"
                class="mr-2"
                @blur="editCategoryName(currentItem.categoryDetailListResultDo!.id)"
              />
        ...
        <div class="w-full grid grid-cols-12 gap-8 p-4 border-b border-gray-200">
          ...
          <div class="col-span-11">
            ...
            <span v-else class="mr-2">
              {{ currentItem.categoryDetailListResultDo.parentCategoryNames.join(' / ') }}
            </span>
            <span>
          ...
          <div class="col-span-11">
            <div class="w-full flex">
              <UploadSingleImage
                ...
                :image-data="currentItem.categoryDetailListResultDo.fileVo"
                class="mr-2"
                style="width: 200px"
              ...
              <div class="grid grid-cols-12 gap-4">
                <div class="col-span-1 flex items-center">
                  <ElButton
                    ...
                    text
                    @click="
                      handleClickUpdateCategoryDescription(
                        currentItem.categoryDetailListResultDo.categoryDescription,
                      )
                    "
                  >
                    <Icon icon="ep:edit" :size="5" class="mr-1" />
                ...
                <div class="col-span-12 border border-gray-200 p-4">
                  <div v-html="currentItem.categoryDetailListResultDo.categoryDescription" />
                </div>
              </div>
            </div>
            <div v-else>
              ...
              <div class="flex justify-center items-center">
                ...
                <ElButton
                  type="primary"
                  @click="editCategoryDescription(currentItem.categoryDetailListResultDo!.id)"
                >
                  {{ $t('common.save') }}
                </ElButton>
              </div>
        ...
        <div class="w-full grid grid-cols-12 gap-8 p-4 border-b border-gray-200">
          ...
          <div class="col-span-11">
            <CustomsTable
              :custom-list="currentItem.categoryDetailListResultDo.customList"
              :category-detail-id="currentItem.categoryDetailListResultDo.id"
            />
          </div>
        </div>
      </div>
